...
import { CheckCircle, Users, Package, ChevronRight, BarChart3, Star, FileText } from 'lucide-react';
  ...
  return (
    <section className="relative pt-36 pb-24 lg:pt-48 lg:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        {/* High-Fidelity Dashboard Mockup - Delay 600ms */}
        <div 
        ...
        >
              ...
              <div className="p-4 sm:p-8 bg-slate-50/50 grid grid-cols-1 md:grid-cols-12 gap-6 text-left">
                ...
                <div className="md:col-span-9 bg-white rounded-2xl border border-gray-100 shadow-sm p-4 sm:p-6 relative overflow-hidden">
                  ...
                  <div className="flex items-start gap-4 sm:gap-6 mb-6 sm:mb-8">
                     <div className="w-16 h-16 sm:w-20 sm:h-20 bg-pink-50 rounded-xl flex items-center justify-center border border-pink-100 flex-shrink-0">
          ...
          {/* Floating Avatar Card - Entrance Delay 800ms */}
          <div 
             ...
             <div className="glass-card p-4 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] animate-float">
                <div className="flex items-center gap-4">
                  <div className="relative">
                    <img src="https://i.pravatar.cc/100?img=5" alt="Manager" className="w-12 h-12 rounded-full border-2 border-white shadow-md" />
